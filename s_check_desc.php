...
return array(
	'plugin' => array(
		'name'        => '登陆注册验证',            //插件名称，必填
		'version'     => '1.1',                 //插件版本号
		'description' => '在注册或登陆的时候，要求拖动图片进行验证',  //插件描述
		'onsale'      =>  false,                 //bool 插件是否已在产品中心上架
		'url'         => 'http://sign.msbear.cn',  //插件地址，比如哪里可以下载到这个插件
		'for'         => 'V4.0+',                 //适用的云签到版本，all为所有版本，版本后面跟+表示适用于该版本或更高版本，如V4.0+
        'forphp'      => 'all'                  //适用的PHP版本，如果定义了，系统就在安装和激活时进行版本对比，如果版本低于forphp，自动禁止下一步操作，all为所有版本
	),
	'author' => array(
		'author'      => 'Msbear',            //作者名称
		'email'       => '396039437@.qq.com',   //作者邮箱
		'url'         => 'http://sign.msbear.cn'   //作者的个人网站
	),
	'view'   => array(
	...
	'page'   => array(
		...
		//定义一个名为phpinfo的自定义页面，位于/plugins/wmzz_debug/view_phpinfo.php
	)
);